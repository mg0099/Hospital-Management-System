 ...
 * @author WIN
 */
public class Patient_Admit_Details extends javax.swing.JFrame {

    /**
     * Creates new form Patient_Admit_Details
     */
    public Patient_Admit_Details() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Patient_Admit_Details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Patient_Admit_Details().setVisible(true);
            }
        });
    }
